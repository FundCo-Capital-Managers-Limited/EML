...
const COMPLAINT_TYPES = [
  "Service issue (electricity, billing, metering, etc.)",
  "Staff behavior",
  "Land/asset use",
  "Safety/security",
    ...
    return (
      <div className="rounded-2xl border border-border bg-surface p-8 text-center">
        ...
        <p className="text-text-secondary">
          Your complaint has been received and will be acknowledged within 3
          working days.
        </p>
      </div>
    );
      ...
      <div>
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm text-text">
            ...
            I want my complaint to remain confidential.
          </label>
          <label className="flex items-center gap-2 text-sm text-text">
