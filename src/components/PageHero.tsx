    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-dark via-navy to-dark text-white">
      {image && (
        <>
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-brand-dark/65 via-navy/60 to-dark/70" />
        </>
      )}
      <div
      ...
      />
      <div
        className="pointer-events-none absolute -bottom-32 left-1/3 h-80 w-80 rounded-full bg-accent/10 blur-3xl"
        aria-hidden
      />
